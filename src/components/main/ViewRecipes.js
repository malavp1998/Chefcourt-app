...
const chefData = [
  {
    ...
    numberOfRecipes: 3,
    bio: " Chef Emily his his culinary education at the famous French School Ecole Du Domaine in Paris, Serge developed his technique whilst working with some the of worlds renowned Credited for the growing popularity of modern Asian cuisine, Chef David Chang founded and owns the Momofuku Restaurant Group, a global enterprise of restaurants, cocktail",
    recipes: [
      {
  ...
  },
  {
    ...
    yearsOfExperience: 8,
    numberOfRecipes: 3,
    bio: "Chef Emily his his culinary education at the famous French School Ecole Du Domaine in Paris, Serge developed his technique whilst working with some the of worlds renowned Chef Emily his his culinary education at the famous French School Ecole Du Domaine in Paris, Serge developed his technique whilst working with some the of worlds renowned",
    recipes: [
      {
        recipeName: "Grilled Salmon",
        ingredients: ["salmon fillet", "lemon", "olive oil", "garlic", "herbs"],
        cookingMethod:
  ...
  },
  {
    ...
    recipes: [
      ...
      },
      {
        ...
        ingredients: ["shrimp", "linguine", "cream sauce", "garlic", "parsley"],
        cookingMethod:
    ...
    recipes: [
      {
        ...
        ingredients: ["beef", "tortillas", "lettuce", "tomatoes", "sour cream"],
        cookingMethod:
...
export default function ViewRecipes() {
  ...
  return (
    <div>
      <Header />
      {chefInfo ? (
        <div className="card m-5" style={{ Width: "100%" }}>
          <div className="row g-0">
            ...
            >
              <img
                ...
                style={{ height: "300px", margin: "2%" }}
              />
            </div>
            <div className="col-md-8">
              <div className="card-body">
                <h3 className="card-title">{chefInfo.chefName}</h3>
                <h5 className="card-subtitle mb-2 text-muted">
                  {chefInfo.yearsOfExperience} year of experience
                </h5>
                <h5 className="card-subtitle mb-2 text-muted">
                  {chefInfo.numberOfRecipes} Recipes
                </h5>
                <p>{chefInfo.bio}</p>
              </div>
            </div>
          ...
          <table class="table table-hover mt-5">
            ...
            <tbody>
              {chefInfo.recipes.map((row, index) => (
                <tr>
                  <th scope="row">{index + 1}</th>
                  <td>{row.recipeName}</td>
                  <td>{row.ingredients.toString()}</td>
                  <td>{row.cookingMethod}</td>
                </tr>
              ))}
            </tbody>
          </table>
